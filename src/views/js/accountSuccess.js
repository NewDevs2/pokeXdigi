...
const container = tagMaker("div", wrap, {
  id: "container",
  style:
    "width:660px; height:100%; background-color:white;display:flex;justify-content:center;align-items:center; ",
});
// 박스
const box = tagMaker("div", container, {
  id: "box",
  style:
    "width:100%; height:640px; display:flex; justify-content:space-evenly;align-items:center; flex-direction:column;",
});
// 박스의 자식 요소들
const checkImg = tagMaker("div", box, {
  id: "checkImg",
  style:
    "width:350px; height:350px; border-radius: 50%;background-color:#FCA311;display:flex; align-items:center; justify-content:center;",
});
// 체크모양 이미지
tagMaker("div", checkImg, {
  style:
    "width : 270px; height : 210px;background-image : url('/src/views/img/whiteCheckMark.png');background-size: cover;",
});
...
const loginButton = tagMaker("input", box, {
  ...
  id: "login",
  style:
    "width:500px; height:100px; font-size:40px; background-color:#FCA311; color:white; border:none; cursor: pointer;",
});
// 로그인 버튼 이벤트
